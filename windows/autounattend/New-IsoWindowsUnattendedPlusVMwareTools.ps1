...
$SourceWindowsIsoPath = 'C:\Users\azureuser\Desktop\VSCodeWorkspace\image\Windows-2019Datacenter_ja-JP.iso'
$VMwareToolsIsoUrl = "https://packages.vmware.com/tools/esx/7.0p03/windows/VMware-tools-windows-11.2.6-17901274.iso"
$AutoUnattendXmlPath = 'C:\Users\azureuser\Desktop\VSCodeWorkspace\Windows-Server-unattended-plus-VMware-Tools\UnattendXML\autounattend.xml'
